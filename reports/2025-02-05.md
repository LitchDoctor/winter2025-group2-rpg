...
### Progress and Issues
* Finished implementing interactle objects
* Still working on implementing UI and had some issues programming an interact button

### Plans and Goals
* Adding inventory UI 
* Adding a pop up message whenever a player comes into contact with an item
